  ...
  return (
    <>
      ...
      <P>
        ...
        remember trying to sign up for twitter with aubble but it happened to be taken. I became frustrated at having
        different usernames for different services and decided to find a name that wasn't taken.
      </P>
      <P>
